...
#### Question: What are the benefits of using P2WSH over P2PKH?
<details>
...
```
[ <signature1>, <signature2>, <witness_script> ]
```
...
```rust
fn two_of_two_multisig_redeem_script(pubkey1: &PublicKey, pubkey2: &PublicKey) -> ScriptBuf {}
```
