...
The next step in our journey towards building a lightning node is setting up a wallet for our node.
...
Before getting into the details, let's review **Bitcoin Improvement Proposal (BIP) 32**. BIP 32  describes a **hierarchical deterministic** (HD) wallet structure that introduces the following characteristics to key management:
