...
Standardizing the public key order in the funding transaction eliminates ambiguity for Bob when reconstructing it to generate a signature for the commitment transaction!
