...
***NOTE***: The Lightning Network fairness protocol is setup up in such a way that **you protect your counterparty** from ***you*** cheating. This is why the output that has ***your*** balance contains the penalty mechanism, while the output with your counterparty's balance is a simple **P2WPKH**. Put simply, if you cheat, your opponent can steal ***your*** output and spend from ***their*** output immediately.
