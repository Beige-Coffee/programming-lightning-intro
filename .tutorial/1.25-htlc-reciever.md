...
You may have been wondering... since Alice and Bob need to exchange key material to invalidate old transactions, isn't one party at a disadvantage? In other words, one party will need to revoke their old state first - does that expose them to a vulnerability?

The peer-to-peer protocol is set up such that both parties are incentivized to cooperate. Take a look a the below example to see how it works. You'll probably need to zoom in!

Once you read the below, try reading [this blog post](https://ellemouton.com/posts/normal-operation-pre-taproot/) by Elle Mouton, which outlines an even more advanced example of updating a Lightning channel.

<p align="center" style="width: 50%; max-width: 300px;">
  <img src="./tutorial_images/channel_operation.png" alt="channel_operation" width="100%" height="auto">
</p>
