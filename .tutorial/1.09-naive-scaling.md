...
<p align="center" style="width: 50%; max-width: 300px;">
  <img src="./tutorial_images/intro_to_htlc/bob_claim.png" alt="bob_claim" width="100%" height="auto">
</p>
...
<p align="center" style="width: 50%; max-width: 300px;">
  <img src="./tutorial_images/intro_to_htlc/AlicePaysBob2.png" alt="AlicePaysBob2" width="90%" height="auto">
</p>
...
Technically, Alice could easily create another transaction that pays Bob 1,000 sats, but then Bob would have to publish two transactions on chain. This means twice the fees! This wouldn't be helpful at all.
...
<details>
  <summary>Click to evolution channel states</summary>

<p align="center" style="width: 50%; max-width: 300px;">
  <img src="./tutorial_images/intro_to_htlc/evolution_states.png" alt="evolution_states" width="80%" height="auto">
</p>
```
