...
A helper function has been provided for you, which you can use to hash two `PublicKey` types.
...
```rust
fn generate_revocation_privkey(per_commitment_secret: &SecretKey, revocation_basepoint_secret: &SecretKey) -> PublicKey {
