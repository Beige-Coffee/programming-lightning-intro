...
<p align="center" style="width: 50%; max-width: 300px;">
  <img src="./tutorial_images/intro_to_htlc/p2wsh_spend.png" alt="p2wsh_spend" width="100%" height="auto">
</p>
...
You may be thinking: "If we know about this bug, why hasn't it been fixed?". Great question. Well it would require a hard fork to fix!
...
- The **witness script** is the script that defines the locking condition for an output. In this example below, it’s the script defining the multisig condition.
