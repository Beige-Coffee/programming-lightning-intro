...
The 5,000 sats are fees paid to Bob! We'll discuss the nuances of fees later in this course, but, for now, it's important to note that Alice will have to pay fees to each hop along the payment route to incentivize the node to forward the payment. Without this economic incentize, Bob has little to gain (outside of altruism) when forwarding the payment.
