...
#### Question: Why is Alice at risk if she creates a new transaction that pays her Bitcoin from Bob's output? In other words, why does this channel only trustlessly support unidirectional payments from Alice to Bob?
<details>
