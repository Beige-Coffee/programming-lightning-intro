...
use bitcoin::{TxOut, BlockHash};

use super::convert::{RawTx, FundedTx, BlockchainInfo};
  ...
  pub fn create_raw_transaction(&self, outputs: Vec<TxOut>) -> String {
    ...
    *sign_raw_tx = Some(tx_hex);
	...
	pub fn get_blockchain_info(&self) -> BlockchainInfo {
		BlockchainInfo {
      latest_height: 151,
      latest_blockhash: bitcoin::blockdata::constants::genesis_block(bitcoin::Network::Regtest).block_hash(),
