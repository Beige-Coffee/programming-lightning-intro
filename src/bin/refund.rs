...
use hex;
use helper::{get_bitcoind_client, get_unspent_output, sign_raw_transaction, get_funding_input};
...
pub async fn create_broadcast_funding_tx(bitcoind: BitcoindClient,
    ...
    let txid = "1a37bcf57b1ec6b272dcf336af7e5271ed4223ab3eac7e1063659c627c01ad4c";
    let txid_index = 0;
...
async fn main() {
    ...
    create_broadcast_funding_tx(bitcoind, our_key_manager, counterparty_key_manager, funding_amount,
